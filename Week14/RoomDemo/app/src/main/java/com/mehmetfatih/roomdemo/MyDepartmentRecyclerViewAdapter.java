...
public class MyDepartmentRecyclerViewAdapter extends RecyclerView.Adapter<MyDepartmentRecyclerViewAdapter.ViewHolder> {
    ...
    public MyDepartmentRecyclerViewAdapter(List<Department> notes, DepartmentFragment.OnDepartmentListInteractionListener listener) {
        mValues = notes;
        mListener = listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mNameView = view.findViewById(R.id.departmentName);
        }
